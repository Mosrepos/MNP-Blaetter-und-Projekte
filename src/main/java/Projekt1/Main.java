package Projekt1;
                ...
                public class Main extends AbstractBehavior<Main.Command> {
                    ...
                    private Main(ActorContext<Command> context, TimerScheduler<Command> timers) {
                        ...
                        for (int i = 1; i <= 4; i++) {
                            workers.add(context.spawn(Worker.create("Arbeiter" + i), "worker" + i));
                        }
                        ...
                        for (ActorRef<ProductionLine.Command> line : productionLines) {
                    ...
                    private Behavior<Command> onAssignOrderToLineTick(AssignOrderToLineTick msg) {
                        getContext().getLog().info("Prüfe Produktionsstraße {} auf verfügbare Kapazität",
                            msg.productionLine.path().name());
